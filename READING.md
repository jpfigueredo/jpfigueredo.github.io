...
Personal bibliography drawn from `/mnt/BACKUP/BACKUP/Livros/`.
...
| 📖 *Fundamentals of Software Architecture* | Neal Ford, Mark Richards | 2020 |
...
| 📖 *The Pragmatic Programmer* (20th anniversary) | Hunt & Thomas | 2019 |
| 📖 *Effective Java* (3rd ed.) | Joshua Bloch | 2017 |
| 📖 *Introduction to Algorithms* (4th ed.) | Cormen, Leiserson, Rivest, Stein | 2022 |
...
| 📖 *Distributed Systems: Principles and Paradigms* (2023) | Tanenbaum & Van Steen | 2023 |
| 📖 *System Design Interview: An Insider's Guide* | Alex Xu | 2020 |
| 📚 *Introdução à Arquitetura e Design de Software* | Caelum | — |
...
| 📚 *Mergulho nos Padrões de Projeto* | Alexander Shvets (Refactoring.Guru) | — |
| 📚 *Code Generation in Action* | Jack Herrington | 2003 |
| 📖 *We, Programmers* | Robert C. Martin | 2025 |
...
| 📚 *Cracking the Coding Interview* (6th ed.) | Gayle Laakmann McDowell | 2015 |
| 📖 *The Art of Multiprocessor Programming* | Herlihy & Shavit | 2008 |
...
| 📚 *Building Secure and Reliable Systems* | Google SRE | 2020 |
...
| 📖 *100 Go Mistakes and How to Avoid Them* | Teiva Harsanyi | 2022 |
| 📖 *Concurrency in Go* | Katherine Cox-Buday | 2017 |
| 📖 *Effective Go* (official guide) | Go Team | — |
...
| 📚 *Livro de Arquitetura e Organização de Computadores* | — | — |
...
| Title | Author | Year |
|---|---|---|
| 📚 *Software Engineering* (9th ed.) | Ian Sommerville | 2010 |
| 📚 *Engenharia de Software* (7th ed.) | Roger Pressman | 2006 |
| 📚 *SWEBOK v4* | IEEE | 2024 |
...
| 📚 *Sprint a Sprint* | Mary Provinciatto | — |
| 📚 *eXtreme Programming* | Casa do Código | — |
| 📚 *Test-Driven Development: Teste e Design no Mundo Real* | Casa do Código | — |
...
|---|---|---|---|
| 📚 *A Startup Enxuta* | Eric Ries | 2011 | Lean manufacturing applied to software — ties to Agile 2001 event |
| 📚 *LEAN Enterprise* | Humble, Molesky, O'Reilly | 2014 | Scale of Agile/Lean in corporations |
| 📚 *Accelerate* | Forsgren, Humble, Kim | 2018 | Empirical study of software delivery performance |
| 📖 *We, Programmers* | Robert C. Martin | 2025 | Chronicle of computing history — direct reference for SW Timeline |
| 📚 *Gestão de Produtos* | Casa do Código | — | Product value vs. technical value tension |
| 📚 *O Programador Apaixonado* | Chad Fowler | 2009 | Career and labor in software — commoditization of programming |
| 📖 *Free Agent Nation* | Daniel Pink | 2001 | Gig economy precursor — ties to platform/SaaS events |
...
| Title | Author | Year |
|---|---|---|
| 📖 *Joe Celko's SQL for Smarties* (4th ed.) | Joe Celko | 2010 |
| 📚 *SQL: Uma Abordagem para Bancos de Dados Oracle* | Casa do Código | — |
| 📚 *PostgreSQL: Banco de Dados para Aplicações Web Modernas* | Casa do Código | — |
| 📚 *JPA Eficaz* | Casa do Código | — |
...
| Title | Author | Year |
|---|---|---|
| 📚 *Firewalls and Internet Security* (2nd ed.) | Cheswick, Bellovin, Rubin | 2003 |
| 📚 *Crypto 101* | — | — |
| 📚 *Building Secure and Reliable Systems* | Google | 2020 |
| 📚 *Segurança em Aplicações Web* | — | — |
| 📚 *WSTG v4.1* (Web Security Testing Guide) | OWASP | — |
